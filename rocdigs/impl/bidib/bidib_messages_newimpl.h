...
#define MSG_NODETAB_OLD         (MSG_USYS + 0x09)       // old version, to be removed!
                                                        // 1:version, 2:length, 3:start, 4..n:nodes
                                                        //      node: local num, unique
#define MSG_NODETAB             (MSG_USYS + 0x09)       // 1:version, 2:local num, 3..9: unique (KW: hier dann einfach jeden Node einzeln)
