...
////@begin RouteDialog content construction
    ...
    wxStaticLine* itemStaticLine104 = new wxStaticLine( m_PermissionsPanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
    itemBoxSizer97->Add(itemStaticLine104, 0, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer105 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer97->Add(itemBoxSizer105, 0, wxALIGN_TOP, 5);
    ...
    m_Commuter->SetSelection(0);
    itemBoxSizer105->Add(m_Commuter, 0, wxALIGN_LEFT|wxALL, 5);
    ...
    itemBoxSizer105->Add(m_Placing, 0, wxALIGN_LEFT|wxALL, 5);
