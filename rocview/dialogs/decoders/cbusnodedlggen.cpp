...
cbusnodedlggen::cbusnodedlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_labIR = new wxStaticText( m_CANGC2Panel, wxID_ANY, wxT("IR"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labIR->Wrap( -1 );
	fgSizer8->Add( m_labIR, 0, wxTOP|wxBOTTOM|wxLEFT|wxALIGN_CENTER_HORIZONTAL, 5 );
