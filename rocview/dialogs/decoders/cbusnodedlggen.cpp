...
cbusnodedlggen::cbusnodedlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	fgSizer8 = new wxFlexGridSizer( 0, 10, 0, 0 );
	...
	m_labGC2IR = new wxStaticText( m_CANGC2Panel, wxID_ANY, wxT("IR"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labGC2IR->Wrap( -1 );
	fgSizer8->Add( m_labGC2IR, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	m_GC2IR1 = new wxRadioButton( m_CANGC2Panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer8->Add( m_GC2IR1, 0, wxLEFT, 5 );
	...
	m_GC2IR2 = new wxRadioButton( m_CANGC2Panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer8->Add( m_GC2IR2, 0, wxLEFT, 5 );
	...
	m_VarValue->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( cbusnodedlggen::onVarValue ), NULL, this );
	...
	m_EventVar->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( cbusnodedlggen::onEV ), NULL, this );
...
cbusnodedlggen::~cbusnodedlggen()
{
	...
	m_VarValue->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( cbusnodedlggen::onVarValue ), NULL, this );
	...
	m_EventVar->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( cbusnodedlggen::onEV ), NULL, this );
