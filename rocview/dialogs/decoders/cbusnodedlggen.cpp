...
cbusnodedlggen::cbusnodedlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_labGC6Servo1SwEvent = new wxStaticText( m_CANGC6Panel, wxID_ANY, wxT("Switch N#"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labGC6Servo1SwEvent->Wrap( -1 );
	fgSizer20->Add( m_labGC6Servo1SwEvent, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );
	
	m_labGC6Servo1SwAddr = new wxStaticText( m_CANGC6Panel, wxID_ANY, wxT("Address"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_labGC6Servo2SwEvent = new wxStaticText( m_CANGC6Panel, wxID_ANY, wxT("Switch N#"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labGC6Servo2SwEvent->Wrap( -1 );
	fgSizer201->Add( m_labGC6Servo2SwEvent, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );
	
	m_labGC6Servo2SwAddr = new wxStaticText( m_CANGC6Panel, wxID_ANY, wxT("Address"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_labGC6Servo3SwEvent = new wxStaticText( m_CANGC6Panel, wxID_ANY, wxT("Switch N#"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labGC6Servo3SwEvent->Wrap( -1 );
	fgSizer202->Add( m_labGC6Servo3SwEvent, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );
	
	m_labGC6Servo3SwAddr = new wxStaticText( m_CANGC6Panel, wxID_ANY, wxT("Address"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_labGC6Servo4SwEvent = new wxStaticText( m_CANGC6Panel, wxID_ANY, wxT("Switch N#"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labGC6Servo4SwEvent->Wrap( -1 );
	fgSizer203->Add( m_labGC6Servo4SwEvent, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );
	
	m_labGC6Servo4SwAddr = new wxStaticText( m_CANGC6Panel, wxID_ANY, wxT("Address"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer27->Add( m_GC6CanID, 0, wxRIGHT, 5 );
	...
	bSizer27->Add( m_GC6SOD, 0, wxRIGHT, 5 );
	...
	m_NoteBook->AddPage( m_CANGC6Panel, wxT("CAN-GC6"), false );
	...
	m_NoteBook->AddPage( m_CANGC7Panel, wxT("CAN-GC7"), false );
