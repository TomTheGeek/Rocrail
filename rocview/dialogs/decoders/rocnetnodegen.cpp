...
rocnetnodegen::rocnetnodegen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_labUpdate = new wxStaticText( m_RocNetPanel, wxID_ANY, wxT("New revision"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labUpdate->Wrap( -1 );
	fgSizer5->Add( m_labUpdate, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT, 5 );
	...
	m_UpdateRevision = new wxTextCtrl( m_RocNetPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer4->Add( m_UpdateRevision, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_Update = new wxButton( m_RocNetPanel, wxID_ANY, wxT("Update"), wxDefaultPosition, wxDefaultSize, 0 );
