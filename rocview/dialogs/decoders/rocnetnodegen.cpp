...
rocnetnodegen::rocnetnodegen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxString m_DCCTypeChoices[] = { wxT("none"), wxT("dcc232"), wxT("sprog"), wxT("rfid12") };
	int m_DCCTypeNChoices = sizeof( m_DCCTypeChoices ) / sizeof( wxString );
	m_DCCType = new wxRadioBox( m_NodeOptions, wxID_ANY, wxT("DCC Type"), wxDefaultPosition, wxDefaultSize, m_DCCTypeNChoices, m_DCCTypeChoices, 1, wxRA_SPECIFY_ROWS );
	m_DCCType->SetSelection( 1 );
	...
	m_DCCDevice = new wxRadioBox( m_NodeOptions, wxID_ANY, wxT("DCC Device"), wxDefaultPosition, wxDefaultSize, m_DCCDeviceNChoices, m_DCCDeviceChoices, 1, wxRA_SPECIFY_COLS );
	m_DCCDevice->SetSelection( 2 );
