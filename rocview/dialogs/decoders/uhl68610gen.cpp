...
uhl68610dlggen::uhl68610dlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_sdbSizer1Help->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( uhl68610dlggen::onHelp ), NULL, this );
...
uhl68610dlggen::~uhl68610dlggen()
{
	...
	m_sdbSizer1Help->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( uhl68610dlggen::onHelp ), NULL, this );
