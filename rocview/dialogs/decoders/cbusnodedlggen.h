...
class cbusnodedlggen : public wxDialog 
{
	...
	protected:
		...
		wxStaticText* m_labGC2Port;
		wxStaticText* m_labGC2EvtNN;
		wxStaticText* m_labGC2EvtAddr;
		wxStaticText* m_LabGC2Input;
		wxStaticText* m_labGC2Sensor;
		wxStaticText* m_labGC2Switch;
		wxStaticText* m_labGC2Pulse;
