...
/// Class rocnetnodegen
///////////////////////////////////////////////////////////////////////////////
class rocnetnodegen : public wxFrame 
{
	private:
	...
	protected:
		...
		wxStaticText* m_labADCThreshold;
		wxSpinCtrl* m_ADCThreshold;
		wxRadioBox* m_IOType;
	...
	public:
		...
		rocnetnodegen( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("RocNetNode"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxCAPTION|wxCLOSE_BOX|wxFRAME_FLOAT_ON_PARENT|wxRESIZE_BORDER|wxTAB_TRAVERSAL );
		~rocnetnodegen();
