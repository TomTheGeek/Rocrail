...
ChannelTuneDlgGen::ChannelTuneDlgGen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_OffPos = new wxSlider( this, wxID_ANY, 2050, 0, 4095, wxDefaultPosition, wxDefaultSize, wxSL_INVERSE|wxSL_LABELS|wxSL_VERTICAL );
	...
	m_OnPos = new wxSlider( this, wxID_ANY, 2050, 0, 4095, wxDefaultPosition, wxDefaultSize, wxSL_INVERSE|wxSL_LABELS|wxSL_VERTICAL );
	...
	m_StdButton->Realize();
	bSizer20->Add( m_StdButton, 0, wxALL|wxALIGN_RIGHT, 5 );
