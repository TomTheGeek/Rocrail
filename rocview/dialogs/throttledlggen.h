...
///////////////////////////////////////////////////////////////////////////////
class ThrottleDlgGen : public wxDialog 
{
	private:
	...
	public:
		...
		ThrottleDlgGen( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Throttle"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER );
		~ThrottleDlgGen();
