...
stagedlggen::stagedlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	fgSizer5->Add( m_SectionID, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	fgSizer5->Add( m_SectionSensor, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
	...
	fgSizer5->Add( m_labOwnSectionLength, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	fgSizer5->Add( m_OwnSectionLength, 0, wxBOTTOM|wxRIGHT|wxLEFT|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_labOccSensor = new wxStaticText( m_Sections, wxID_ANY, wxT("Occupancy"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labOccSensor->Wrap( -1 );
	fgSizer5->Add( m_labOccSensor, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	fgSizer5->Add( m_OccSensor, 0, wxEXPAND|wxBOTTOM|wxRIGHT|wxLEFT|wxALIGN_CENTER_VERTICAL, 5 );
