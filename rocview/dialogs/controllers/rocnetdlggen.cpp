...
rocnetdlggen::rocnetdlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_RNID = new wxSpinCtrl( m_ConnectionPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 0 );
	...
	m_OptionsBox->Add( m_ShutdownAll, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
