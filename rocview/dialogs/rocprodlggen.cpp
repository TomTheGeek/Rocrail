...
RocProDlgGen::RocProDlgGen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_Direct = new wxCheckBox( this, wxID_ANY, wxT("Direct"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer5->Add( m_Direct, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer6->Add( m_Fx, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
