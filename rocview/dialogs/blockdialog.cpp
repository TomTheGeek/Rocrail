...
void BlockDialog::initLabels() {
  ...
  */
  ...
  m_labFsAheadFrom->SetLabel( wxGetApp().getMsg( "aheadfrom" ) );
  m_LabelSignalR->SetLabel( wxGetApp().getMsg( "signal" ) );
  m_LabelWSignalR->SetLabel( wxGetApp().getMsg( "distant_signal" ) );
  m_labRsAheadFrom->SetLabel( wxGetApp().getMsg( "aheadfrom" ) );
...
void BlockDialog::initValues() {
  ...
  */
  ...
  m_FsAheadFrom->SetValue( wxString(wBlock.getfsaheadfrom( m_Props ),wxConvUTF8) );
  m_RsAheadFrom->SetValue( wxString(wBlock.getrsaheadfrom( m_Props ),wxConvUTF8) );
...
////@begin BlockDialog content construction
    ...
    wxStaticLine* itemStaticLine46 = new wxStaticLine( m_LocationPanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
    itemBoxSizer45->Add(itemStaticLine46, 0, wxGROW|wxALL, 5);

    m_Location = new wxStaticBox(m_LocationPanel, wxID_ANY, _("Location"));
    wxStaticBoxSizer* itemStaticBoxSizer47 = new wxStaticBoxSizer(m_Location, wxVERTICAL);
    itemBoxSizer45->Add(itemStaticBoxSizer47, 0, wxALIGN_TOP|wxALL, 5);
    wxFlexGridSizer* itemFlexGridSizer48 = new wxFlexGridSizer(2, 4, 0, 0);
    itemStaticBoxSizer47->Add(itemFlexGridSizer48, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);
    ...
    wxStaticText* itemStaticText55 = new wxStaticText( m_LocationPanel, wxID_ANY, _("ori"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer48->Add(itemStaticText55, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_Ori = new wxTextCtrl( m_LocationPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY );
    itemFlexGridSizer48->Add(m_Ori, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    m_PanelWirering->SetSizer(itemBoxSizer58);
    ...
    itemFlexGridSizer60->Add(m_LabelWSignal, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemFlexGridSizer60->Add(m_labFsAheadFrom, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_FsAheadFrom = new wxTextCtrl( m_PanelWirering, wxID_ANY, _("all"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer60->Add(m_FsAheadFrom, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemBoxSizer58->Add(itemStaticBoxSizer69, 0, wxGROW|wxALL, 5);
    ...
    itemFlexGridSizer70->Add(m_labRsAheadFrom, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_RsAheadFrom = new wxTextCtrl( m_PanelWirering, wxID_ANY, _("all-reverse"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer70->Add(m_RsAheadFrom, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    wxFlexGridSizer* itemFlexGridSizer82 = new wxFlexGridSizer(1, 4, 0, 0);
    ...
    wxFlexGridSizer* itemFlexGridSizer87 = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    itemFlexGridSizer102->Add(m_SpeedPercent, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticText* itemStaticText105 = new wxStaticText( m_PanelDetails, wxID_STATIC, _("%"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer102->Add(itemStaticText105, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);
    ...
    itemFlexGridSizer102->Add(m_ExitSpeed, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    itemStaticBoxSizer101->Add(m_Type, 0, wxALIGN_TOP|wxALL, 5);
    ...
    m_RoutesPanel->SetSizer(itemBoxSizer109);
    ...
    itemBoxSizer109->Add(m_Routes, 1, wxGROW|wxALL, 5);

    m_LabelSensorsFromBlock = new wxStaticText( m_RoutesPanel, wxID_STATIC_SENSORS_TITLE, _("..."), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer109->Add(m_LabelSensorsFromBlock, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    wxFlexGridSizer* itemFlexGridSizer112 = new wxFlexGridSizer(2, 4, 0, 0);
    itemBoxSizer109->Add(itemFlexGridSizer112, 0, wxGROW|wxALL, 5);
    ...
    itemFlexGridSizer112->Add(m_LabelSensorIDs, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxTOP, 2);
    ...
    itemFlexGridSizer112->Add(m_LabelSensorActions, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxTOP, 2);

    m_LabelSensorEnd = new wxStaticText( m_RoutesPanel, wxID_STATIC_BLOCK_SENSOR_END, _("End:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer112->Add(m_LabelSensorEnd, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 2);
    ...
    itemFlexGridSizer112->Add(m_LabelProps, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxTOP, 5);
    ...
    itemFlexGridSizer112->Add(m_SensorID1, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorAction1, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorEnd1, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);

    m_SensorProps1 = new wxButton( m_RoutesPanel, ID_BUTTON_BLOCKS_SENSOR_PROPS1, _("..."), wxDefaultPosition, wxSize(30, 25), 0 );
    itemFlexGridSizer112->Add(m_SensorProps1, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorID2, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorAction2, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorEnd2, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);

    m_SensorProps2 = new wxButton( m_RoutesPanel, ID_BUTTON_BLOCK_SENSOR_PROPS2, _("..."), wxDefaultPosition, wxSize(30, 25), 0 );
    itemFlexGridSizer112->Add(m_SensorProps2, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorID3, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorAction3, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorEnd3, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);

    m_SensorProps3 = new wxButton( m_RoutesPanel, ID_BUTTON_BLOCKS_SENSOR_PROPS3, _("..."), wxDefaultPosition, wxSize(30, 25), 0 );
    itemFlexGridSizer112->Add(m_SensorProps3, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorID4, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorAction4, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorEnd4, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);

    m_SensorProps4 = new wxButton( m_RoutesPanel, ID_BUTTON_BLOCKS_SENSOR_PROPS4, _("..."), wxDefaultPosition, wxSize(30, 25), 0 );
    itemFlexGridSizer112->Add(m_SensorProps4, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorID5, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorAction5, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ...
    itemFlexGridSizer112->Add(m_SensorEnd5, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);

    m_SensorProps5 = new wxButton( m_RoutesPanel, ID_BUTTON_BLOCKS_SENSOR_PROPS5, _("..."), wxDefaultPosition, wxSize(30, 25), 0 );
    itemFlexGridSizer112->Add(m_SensorProps5, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);

    wxBoxSizer* itemBoxSizer137 = new wxBoxSizer(wxHORIZONTAL);
    itemBoxSizer109->Add(itemBoxSizer137, 0, wxGROW|wxALL, 5);
    m_labTimer = new wxStaticText( m_RoutesPanel, wxID_STATIC_BK_TIMER, _("Event timer"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer137->Add(m_labTimer, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemBoxSizer154->Add(m_IncludeList, 1, wxGROW|wxALL, 5);

    m_labExclude = new wxStaticText( m_PermissionsPanel, wxID_ANY, _("Exclude"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer154->Add(m_labExclude, 0, wxALIGN_LEFT|wxALL, 5);
    ...
    itemBoxSizer154->Add(m_ExcludeList, 1, wxGROW|wxALL, 5);
    ...
    itemBoxSizer154->Add(m_PermType, 0, wxGROW|wxALL, 5);
