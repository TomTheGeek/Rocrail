...
////@begin LocDialog content construction
    ...
    wxFlexGridSizer* itemFlexGridSizer319 = new wxFlexGridSizer(0, 6, 0, 0);
    ...
    itemFlexGridSizer319->Add(m_BBTFixed, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
