...
decconfigdlggen::decconfigdlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bSizer1->Add( m_ExtAddressing, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
	
	m_RailCom = new wxCheckBox( this, wxID_ANY, wxT("RailCom"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer1->Add( m_RailCom, 0, wxALL, 5 );
	...
	m_stdButtonHelp->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( decconfigdlggen::onHelp ), NULL, this );
...
decconfigdlggen::~decconfigdlggen()
{
	...
	m_stdButtonHelp->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( decconfigdlggen::onHelp ), NULL, this );
