...
void RocrailIniDialog::initValues() {
  ...
  m_TriggerBlockEvents->Enable(wCtrl.istriggerblockevents( ctrl ) ? true:false);
...
////@begin RocrailIniDialog content construction
    ...
    itemBoxSizer198->Add(itemStaticBoxSizer206, 0, wxGROW|wxALL, 5);
    wxFlexGridSizer* itemFlexGridSizer207 = new wxFlexGridSizer(0, 2, 0, 0);
