...
////@begin RocrailIniDialog content construction
    ...
    m_ServicePanel->SetSizer(itemBoxSizer69);

    wxBoxSizer* itemBoxSizer70 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer69->Add(itemBoxSizer70, 0, wxALIGN_TOP|wxALL, 5);
    wxStaticBox* itemStaticBoxSizer71Static = new wxStaticBox(m_ServicePanel, wxID_ANY, _("HTTP Service"));
    m_HttpBox = new wxStaticBoxSizer(itemStaticBoxSizer71Static, wxHORIZONTAL);
    itemBoxSizer70->Add(m_HttpBox, 0, wxGROW|wxALL, 5);
    ...
    wxStaticBox* itemStaticBoxSizer76Static = new wxStaticBox(m_ServicePanel, wxID_ANY, _("Web Service"));
    m_WebServiceBox = new wxStaticBoxSizer(itemStaticBoxSizer76Static, wxHORIZONTAL);
    itemBoxSizer70->Add(m_WebServiceBox, 0, wxGROW|wxALL, 5);
    ...
    itemBoxSizer70->Add(m_ClockBox, 0, wxGROW|wxALL, 5);
    ...
    itemBoxSizer70->Add(m_ClientBox, 0, wxGROW|wxALL, 5);
    ...
    itemBoxSizer69->Add(itemStaticLine101, 0, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer102 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer69->Add(itemBoxSizer102, 0, wxGROW|wxALL, 5);
    ...
    itemFlexGridSizer160->Add(m_UseBlockSide, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer160->Add(m_TriggerBlockEvents, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer160->Add(m_CloseNoEvents, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer160->Add(m_SelectShortestBlock, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer160->Add(m_RestoreSchedule, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer160->Add(m_ActionTimer60, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

    wxStaticLine* itemStaticLine187 = new wxStaticLine( m_AtomatPanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
    itemBoxSizer123->Add(itemStaticLine187, 0, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer188 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer123->Add(itemBoxSizer188, 0, wxALIGN_TOP|wxALL, 5);
    ...
    itemStaticBoxSizer220->Add(m_AddFeedbackBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxBOTTOM, 5);
