...
////@begin RocrailIniDialog content construction
    ...
    wxStaticLine* itemStaticLine187 = new wxStaticLine( m_AtomatPanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
    itemBoxSizer128->Add(itemStaticLine187, 0, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer188 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer128->Add(itemBoxSizer188, 0, wxALIGN_TOP|wxALL, 5);
    ...
    itemBoxSizer188->Add(m_ActionTimer60, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer188->Add(m_RestoreSchedule, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer188->Add(m_SelectShortestBlock, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer188->Add(m_CloseNoEvents, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer188->Add(m_GreenAspect, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    m_DefAspect->SetSelection(0);
    itemBoxSizer188->Add(m_DefAspect, 0, wxALIGN_LEFT|wxALL, 5);
    ...
    m_ControllersPanel->SetSizer(itemBoxSizer196);
    ...
    itemBoxSizer196->Add(m_Controllers, 1, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer198 = new wxBoxSizer(wxHORIZONTAL);
    itemBoxSizer196->Add(itemBoxSizer198, 0, wxGROW|wxALL, 5);
    m_ControllerDelete = new wxButton( m_ControllersPanel, ID_BUTTON_RR_DELETE, _("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer198->Add(m_ControllerDelete, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_ControllerProps = new wxButton( m_ControllersPanel, ID_BUTTON_RR_PROPS, _("Properties"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer198->Add(m_ControllerProps, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer201Static = new wxStaticBox(m_ControllersPanel, wxID_ANY, _("Add Controller"));
    m_AddControllerBox = new wxStaticBoxSizer(itemStaticBoxSizer201Static, wxHORIZONTAL);
    itemBoxSizer196->Add(m_AddControllerBox, 0, wxGROW|wxALL, 5);
    ...
    wxStaticBoxSizer* itemStaticBoxSizer204 = new wxStaticBoxSizer(m_ControllerOptionsBox, wxVERTICAL);
    itemBoxSizer196->Add(itemStaticBoxSizer204, 0, wxGROW|wxALL, 5);
    wxFlexGridSizer* itemFlexGridSizer205 = new wxFlexGridSizer(0, 2, 0, 0);
    ...
    itemFlexGridSizer205->Add(m_PowerOffOnExit, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemFlexGridSizer205->Add(m_NoDevCheck, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    m_R2RnetPanel->SetSizer(itemBoxSizer209);
    ...
    itemBoxSizer209->Add(m_R2RnetEnable, 0, wxALIGN_LEFT|wxALL, 5);
    ...
    m_AnalyserPanel->SetSizer(itemBoxSizer223);

    m_AnaGenerate = new wxStaticBox(m_AnalyserPanel, wxID_ANY, _("Analyze"));
    wxStaticBoxSizer* itemStaticBoxSizer224 = new wxStaticBoxSizer(m_AnaGenerate, wxVERTICAL);
    itemBoxSizer223->Add(itemStaticBoxSizer224, 0, wxGROW|wxALL, 5);
    ...
    itemStaticBoxSizer224->Add(m_SetRouteId, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer224->Add(m_SetBlockId, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer224->Add(m_AddSignalBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer224->Add(m_AddFeedbackBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);

    m_AnaClean = new wxStaticBox(m_AnalyserPanel, wxID_ANY, _("Clean all Analyze"));
    wxStaticBoxSizer* itemStaticBoxSizer229 = new wxStaticBoxSizer(m_AnaClean, wxVERTICAL);
    itemBoxSizer223->Add(itemStaticBoxSizer229, 0, wxGROW|wxALL, 5);
    ...
    itemStaticBoxSizer229->Add(m_CleanRouteId, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer229->Add(m_ResetBlockId, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer229->Add(m_ResetSignalBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer229->Add(m_ResetFeedbackBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_AnaCheck = new wxStaticBox(m_AnalyserPanel, wxID_ANY, _("Extended plan check"));
    wxStaticBoxSizer* itemStaticBoxSizer234 = new wxStaticBoxSizer(m_AnaCheck, wxVERTICAL);
    itemBoxSizer223->Add(itemStaticBoxSizer234, 0, wxGROW|wxALL, 5);
    ...
    itemStaticBoxSizer234->Add(m_BasicCheck, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer234->Add(m_BlockCheck, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer234->Add(m_RouteCheck, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer234->Add(m_ActionCheck, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_AnaReset = new wxStaticBox(m_AnalyserPanel, wxID_ANY, _("Extended plan clean"));
    wxStaticBoxSizer* itemStaticBoxSizer239 = new wxStaticBoxSizer(m_AnaReset, wxVERTICAL);
    itemBoxSizer223->Add(itemStaticBoxSizer239, 0, wxGROW|wxALL, 5);
    ...
    itemStaticBoxSizer239->Add(m_BasicClean, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer239->Add(m_BlockClean, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer239->Add(m_RouteClean, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer239->Add(m_ActionClean, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    itemBoxSizer2->Add(itemStdDialogButtonSizer244, 0, wxALIGN_RIGHT|wxALL, 5);
    m_OK = new wxButton( itemDialog1, wxID_OK, _("&OK"), wxDefaultPosition, wxDefaultSize, 0 );
    m_OK->SetDefault();
    itemStdDialogButtonSizer244->AddButton(m_OK);

    m_Cancel = new wxButton( itemDialog1, wxID_CANCEL, _("&Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
    itemStdDialogButtonSizer244->AddButton(m_Cancel);
