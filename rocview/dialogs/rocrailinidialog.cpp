...
////@begin RocrailIniDialog content construction
    ...
    itemFlexGridSizer102->Add(m_PowerOffAtReset, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    m_ControllersPanel->SetSizer(itemBoxSizer118);
    ...
    itemBoxSizer118->Add(m_Controllers, 1, wxGROW|wxALL, 5);
    ...
    itemBoxSizer120->Add(m_ControllerDelete, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_ControllerProps = new wxButton( m_ControllersPanel, ID_BUTTON_RR_PROPS, _("Properties"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer120->Add(m_ControllerProps, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer123Static = new wxStaticBox(m_ControllersPanel, wxID_ANY, _("Add Controller"));
    m_AddControllerBox = new wxStaticBoxSizer(itemStaticBoxSizer123Static, wxHORIZONTAL);
    itemBoxSizer118->Add(m_AddControllerBox, 0, wxGROW|wxALL, 5);
    ...
    wxStaticBoxSizer* itemStaticBoxSizer126 = new wxStaticBoxSizer(m_ControllerOptionsBox, wxVERTICAL);
    ...
    itemFlexGridSizer127->Add(m_PowerOffOnExit, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    m_R2RnetPanel->SetSizer(itemBoxSizer130);

    wxFlexGridSizer* itemFlexGridSizer131 = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    itemBoxSizer130->Add(m_R2RnetEnable, 0, wxALIGN_LEFT|wxALL, 5);
    ...
    itemStdDialogButtonSizer143->AddButton(m_Apply);
