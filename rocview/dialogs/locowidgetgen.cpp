...
LocoWidgetGen::LocoWidgetGen( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_Destination->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( LocoWidgetGen::onDestination ), NULL, this );
}
...
LocoWidgetGen::~LocoWidgetGen()
{
	...
	m_Destination->Disconnect( wxEVT_RIGHT_UP, wxMouseEventHandler( LocoWidgetGen::onDestination ), NULL, this );
