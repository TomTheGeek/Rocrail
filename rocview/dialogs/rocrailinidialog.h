...
////@begin RocrailIniDialog member variables
    ...
    wxCheckBox* m_RestrictedEventTimers;
    ...
    wxCheckBox* m_BlockFeedbackActionCheck;
    wxCheckBox* m_BlockRouteFbValidation;
    wxCheckBox* m_SeltabRouteFbValidation;
    wxStaticBox* m_AnaReset;
    wxCheckBox* m_BlockFeedbackActionCheckClean;
    wxCheckBox* m_BlockRouteFbValidationClean;
    wxCheckBox* m_SeltabRouteFbValidationClean;
    wxButton* m_OK;
    wxButton* m_Cancel;
    iONode m_Props;
    iONode m_Controller;
