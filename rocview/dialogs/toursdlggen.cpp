...
toursdlggen::toursdlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	fgSizer3->Add( m_ScheduleList, 0, wxALL|wxEXPAND, 5 );
	
	m_ScheduleProps = new wxButton( m_SchedulesPanel, wxID_ANY, wxT("Properties..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_ScheduleProps, 0, wxALL, 5 );
	...
	m_Up = new wxButton( m_SchedulesPanel, wxID_ANY, wxT("Up"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer10->Add( m_Up, 0, wxALL, 5 );
	
	m_Down = new wxButton( m_SchedulesPanel, wxID_ANY, wxT("Down"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer10->Add( m_Down, 0, wxALL, 5 );
	...
	m_Copy->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onCopy ), NULL, this );
	...
	m_ScheduleProps->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onScheduleProps ), NULL, this );
	...
	m_Up->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onUp ), NULL, this );
	m_Down->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onDown ), NULL, this );
	...
	m_DefaultButtonsHelp->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onHelp ), NULL, this );
...
toursdlggen::~toursdlggen()
{
	...
	m_Copy->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onCopy ), NULL, this );
	...
	m_ScheduleProps->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onScheduleProps ), NULL, this );
	...
	m_Up->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onUp ), NULL, this );
	m_Down->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onDown ), NULL, this );
	...
	m_DefaultButtonsHelp->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( toursdlggen::onHelp ), NULL, this );
