...
void LC::CreateControls() {
  ...
  l_sizer0->Add(m_FG, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_LEFT|wxALL, 0);

  m_V = new wxTextCtrl( m_Parent, -1, _("0"), wxDefaultPosition, wxDefaultSize, wxTE_READONLY|wxTE_CENTRE );
  l_sizer0->Add(m_V, 0, wxALIGN_CENTER_VERTICAL|wxGROW|wxALL, 0);
  ...
  m_Button1Sizer->Add(m_F1, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);

  m_F2 = new wxButton( m_Parent, -1, _("F2"), wxDefaultPosition, wxSize(40, -1), wxBU_EXACTFIT );
  m_Button1Sizer->Add(m_F2, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);

  m_F0 = new wxButton( m_Parent, -1, _("F0"), wxDefaultPosition, wxSize(40, -1), wxBU_EXACTFIT );
  m_Button1Sizer->Add(m_F0, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);
  ...
  m_Button2Sizer->Add(m_F3, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);

  m_F4 = new wxButton( m_Parent, -1, _("F4"), wxDefaultPosition, wxSize(40, -1), wxBU_EXACTFIT );
  m_Button2Sizer->Add(m_F4, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);

  m_Dir = new wxButton( m_Parent, -1, _(">>"), wxDefaultPosition, wxSize(40, -1), wxBU_EXACTFIT );
  m_Button2Sizer->Add(m_Dir, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);
  ...
  m_Stop = new wxButton( m_Parent, -1, _("Stop"), wxDefaultPosition, wxDefaultSize, 0 );
  m_ButtonSizer->Add(m_Stop, 0, wxGROW|wxALL, 0);
