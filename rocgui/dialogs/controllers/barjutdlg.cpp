...
{
  Create(parent, -1, wxGetApp().getMsg("barjut"));
  m_Props = props;
  initLabels();
  initValues();
...
////@begin BarJuTCntrlDlg content construction
    // Generated by DialogBlocks, 06/05/2007 10:57:59 (unregistered)
    ...
    m_Device = new wxTextCtrl( itemPanel3, ID_TEXTCTRL_BARJUT_DEVICE, _T(""), wxDefaultPosition, wxDefaultSize, 0 );
