...
////@begin RocrailIniDialog content construction
    ...
    wxFlexGridSizer* itemFlexGridSizer93 = new wxFlexGridSizer(2, 1, 0, 0);
    itemBoxSizer69->Add(itemFlexGridSizer93, 0, wxGROW, 5);
    ...
    itemFlexGridSizer93->Add(m_Check2In, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemFlexGridSizer93->Add(m_secondNextBlock, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer93->Add(m_EnableSwFb, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer93->Add(m_DisableRouteVreduce, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer93->Add(m_GreenAspect, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer93->Add(m_SkipSetSw, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer93->Add(m_UseBiCom, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer93->Add(m_StopAtIdentMisMatch, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    m_DefAspect->SetSelection(0);
    itemFlexGridSizer93->Add(m_DefAspect, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    m_ControllersPanel->SetSizer(itemBoxSizer104);
    ...
    itemBoxSizer104->Add(m_Controllers, 1, wxGROW|wxALL, 5);
    ...
    itemBoxSizer106->Add(m_ControllerDelete, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_ControllerProps = new wxButton( m_ControllersPanel, ID_BUTTON_RR_PROPS, _("Properties"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer106->Add(m_ControllerProps, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer109Static = new wxStaticBox(m_ControllersPanel, wxID_ANY, _("Add Controller"));
    m_AddControllerBox = new wxStaticBoxSizer(itemStaticBoxSizer109Static, wxHORIZONTAL);
    itemBoxSizer104->Add(m_AddControllerBox, 0, wxGROW|wxALL, 5);
    ...
    m_R2RnetPanel->SetSizer(itemBoxSizer113);
    ...
    itemBoxSizer113->Add(m_R2RnetEnable, 0, wxALIGN_LEFT|wxALL, 5);
    ...
    itemStdDialogButtonSizer126->AddButton(m_Apply);
