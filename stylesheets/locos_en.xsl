...
<xsl:template match="/">
  ...
  <body>
  <h2>Locomotives report</h2>

  <table border="4" rules="all" cellpadding="3" cellspacing="0" width="100%">
      <THEAD>
	  <TR>
	             <TH width="10%" height="20" bgcolor="lightgrey">Picture</TH>
              <TH width="15%" bgcolor="lightgrey">ID</TH>
              <TH width="7%" bgcolor="lightgrey">Address</TH>
              <TH width="7%" bgcolor="lightgrey">Length</TH>
              <TH width="8%" bgcolor="lightgrey">Engine</TH>
              <TH width="11%" bgcolor="lightgrey">Train type</TH>
              <TH width="7%" bgcolor="lightgrey">Commuter</TH>              
...
<!-- if in table of loco list -->   
    ...
    <table border="0" rules="all" cellpadding="2" cellspacing="0" width="100%">
      <THEAD>
	  <TR>
              <TH width="5%" bgcolor="white">Era</TH>            
              <TH width="15%" height="5" bgcolor="white">Roadname</TH>
              <TH width="28%" bgcolor="white">Decoder</TH>
              <TH width="7%" bgcolor="white">Protocol</TH>  
              <TH width="8%" bgcolor="white">Decoder steps</TH>                          
              <TH width="25%" bgcolor="white">Train (length)</TH>
              <TH width="6%" bgcolor="white">Run time</TH>
              <TH width="6%" bgcolor="white">purchased</TH>
        ...
        <table border="0" rules="all" cellpadding="2" cellspacing="0" width="100%">
          <THEAD>
            <TR>
              ...
              <TH width="5%" bgcolor="white">BWT Loco</TH>
              <TH width="5%" bgcolor="white">own BWT</TH>
              <TH width="15%" bgcolor="white">Use shortin</TH>
              <TH width="15%" bgcolor="white">Stop at pre2In</TH>
            </TR>
          </THEAD>
          <TBODY>
            <TR>
