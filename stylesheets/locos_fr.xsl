...
<xsl:template match="/">
  ...
  <table border="1" rules="all" cellpadding="4" cellspacing="0" width="100%">
      <THEAD>
	  <TR>
	     <TH width="20%" height="30" bgcolor="lightgrey">Photo</TH>
	     <TH width="10%" height="30" bgcolor="lightgrey">ID</TH>
 	     ...
 	     <TH width="50%" bgcolor="lightgrey">Description</TH>
	  </TR>
      </THEAD> 
      <TBODY>
        <xsl:apply-templates/>
...
<xsl:template match="lc">  
    ...
    <table border="0" rules="all" cellpadding="4" cellspacing="0" width="100%">
      <THEAD>
	  <TR>
	     <TH width="25%" height="30" bgcolor="white">Achet&#233;</TH>
	     <TH width="25%" height="30" bgcolor="white">Temps d'utilisation</TH>
	     <TH width="25%" height="30" bgcolor="white">Vitesse min</TH>
 	     <TH width="25%" bgcolor="white">Vitesse max</TH>
	  </TR>
      </THEAD> 
      <TBODY>
      <TR>
