...
////@begin SelTabTrackDialog content construction
    ...
    m_Desc = new wxTextCtrl( itemDialog1, wxID_ANY, _T(""), wxDefaultPosition, wxSize(200, -1), 0 );
    ...
    m_BlockID = new wxComboBox( itemDialog1, wxID_ANY, _T(""), wxDefaultPosition, wxDefaultSize, m_BlockIDStrings, wxCB_DROPDOWN );
    ...
    m_Sen1 = new wxComboBox( itemDialog1, wxID_ANY, _T(""), wxDefaultPosition, wxDefaultSize, m_Sen1Strings, wxCB_DROPDOWN );
    ...
    m_Sen2 = new wxComboBox( itemDialog1, wxID_ANY, _T(""), wxDefaultPosition, wxDefaultSize, m_Sen2Strings, wxCB_DROPDOWN );
